...
namespace H.Necessaire.Runtime.Azure.CosmosDB.Analytics.Resources
{
    internal class ConsumerAnalyticsAzureCosmosDbProviderResource
        : ImADependency, ImAConsumerAnalyticsProvider
    {
        #region Construct
