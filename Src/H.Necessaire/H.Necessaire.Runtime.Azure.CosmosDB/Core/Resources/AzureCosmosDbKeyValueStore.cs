...
{
    internal class AzureCosmosDbKeyValueStore
        : AzureCosmosDbStorageResourceBase<string, AzureCosmosDbKeyValueStore.KeyValueEntry, AzureCosmosDbKeyValueStore.KeyValueFilter>
        , IKeyValueStorage
    {
        #region Construct
        readonly string storeName = "Default";
        public AzureCosmosDbKeyValueStore(string storeName = null)
        {
