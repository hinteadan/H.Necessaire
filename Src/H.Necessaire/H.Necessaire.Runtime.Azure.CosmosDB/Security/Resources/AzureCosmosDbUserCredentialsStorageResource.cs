...
{
    internal class AzureCosmosDbUserCredentialsStorageResource
        : AzureCosmosDbStorageResourceBase<Guid, UserCredentials, UserCredentialsFilter>, ImAUserCredentialsStorageResource
    {
