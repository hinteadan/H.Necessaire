...
{
    public abstract class DapperSqlServerStorageResourceBase<TId, TEntity, TSqlEntity, TFilter>
    ...
    {
        #region Construct
        protected DapperSqlServerStorageResourceBase(string connectionString = null, string tableName = null, string databaseName = null)
