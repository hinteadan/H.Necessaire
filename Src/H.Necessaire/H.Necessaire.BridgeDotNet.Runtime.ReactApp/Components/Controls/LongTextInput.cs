...
{
    public class LongTextInput : ComponentBase<LongTextInput.Props, LongTextInput.State>
    {
        public LongTextInput(Props props) : base(props, null) { }
        public LongTextInput() : this(new Props { }) { }
        ...
        private void EnableOnFocusedStyle(HTMLTextAreaElement inputElement)
        {
        ...
        private void DisableOnFocusedStyle(HTMLTextAreaElement inputElement)
        {
        ...
        public class Props : ComponentPropsBase
        {
            ...
            public Func<TextAreaAttributes, TextAreaAttributes> Decorator { get; set; }
