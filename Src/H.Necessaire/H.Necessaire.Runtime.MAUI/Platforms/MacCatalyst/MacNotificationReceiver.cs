...
namespace H.Necessaire.Runtime.MAUI.Platforms.MacCatalyst
{
    public class IosNotificationReceiver : UNUserNotificationCenterDelegate
    {
        ...
        ImAMacNotificationPoster notificationManager;
        public IosNotificationReceiver()
        {
            notificationPoster = IPlatformApplication.Current?.Services.GetService<MacNotificationService>();
            notificationManager = notificationPoster as ImAMacNotificationPoster;
        }
